...
SVG_MECH_A = f"""<div class="figpanel"><div class="pt">① 근육을 풀어 통증 고리를 끊는다</div>
...
<div class="figimg"><img src="__FIG_NOCI__" alt="통각신경 종말 — 신경펩타이드 방출 차단과 역행성 수송"/>
 <span class="lb" style="left:27%;top:11%">통각신경 종말 (C섬유)</span>
 <span class="lb red" style="left:34%;top:58%">substance P · CGRP 방출 차단</span>
 <span class="lb ind" style="left:61%;top:30%">역행성 축삭수송</span>
 <span class="lb ind" style="left:71%;top:79%">후근신경절 · 중추 감작 ↓</span>
</div>
...
{'t': 'title', 'eyebrow': 'Botulinum Toxin in Orthopedic Pain · 문헌고찰',
 ...
 'order': '머리 · 목어깨 · 팔 · 허리 · 엉덩이 · 무릎 · 종아리 · 발',
 'series': SERIES},
...
{'t': 'bullets', 'eyebrow': '들어가며', 'tag': '이 발표의 틀',
 ...
 'items': [
   ...
   (0, '이 발표는 <b>머리에서 발까지</b> 내려가며, 부위마다 <b>① 근거 → ② 주사기법 → ③ 용량 → ④ 부작용 → ⑤ 회피법</b> 순으로 정리한다.', 'accent'),
...
{'t': 'table', 'eyebrow': '총괄', 'tag': ('근거 지도', 'ink'), 'dense': True,
 ...
 'rows': [
   ['머리 · 얼굴 — 삼차 · 대상포진후 · 외상후 신경통', '<b>A</b>', 'AAN 기준 effective (Jabbari 2018)'],
   ['목 · 어깨 — <b>승모근 근막통증</b>', '<b>C</b> (제한적)', 'MA 7편: 통계적 유의, <b>임상적 유의성 미달</b>'],
   ['어깨 — 편마비성 어깨통증 (견갑하근)', '<b>C</b>', 'Stroke 2021 RCT 유의 · 표적 따라 결과 갈림'],
 ...
 'note': 'A=효과 있음 · B=아마 효과 있음 · C=효과 가능성(AAN 분류) · <b>머리에서 발까지 해부학적 순서</b>로 정렬했다.',
...
# 07 ─────────────────────────────────────────────────────
{'t': 'bullets', 'eyebrow': '머리 · 얼굴 → 전신', 'tag': ('Level A', 'green'),
...
{'t': 'key', 'eyebrow': 'Key Messages',
 ...
 'msgs': [
   ...
   ('가장 강한 곳', '정형외과 영역에서 근거가 가장 단단한 곳은 <b>신경통(A)</b>, 그다음 <b>요통·이상근·무릎·경련·족저근막염(B)</b>.'),
