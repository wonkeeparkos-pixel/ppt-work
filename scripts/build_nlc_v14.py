...
SERIES = "고령 하지증상 문헌고찰 시리즈 · 2026 · v1.4"
...
NLC = [
 ...
 {'t':'figure','eyebrow':'병태생리','tag':('그림으로',''),'title':'가속과 브레이크 — 왜 짧아진 근육에서 경련이 나나',
  ...
  'svg':('<img src="__PAGE3IMG__" alt="반사 균형과 경련" '
         'style="max-height:100%;max-width:33cqw;width:auto;object-fit:contain;align-self:center;border-radius:1.4cqw;border:1.5px solid #E4E9E8"/>'
         '<div style="flex:1;max-width:46cqw;display:flex;flex-direction:column;justify-content:center;gap:1.6cqw;text-align:left">'
         '<div style="font-weight:800;font-size:2.3cqw;color:#17232C;letter-spacing:-.01em">이 그림이 말하는 것</div>'
         '<div style="font-weight:300;font-size:2.0cqw;line-height:1.3;color:#33403B">'
         '<span style="display:inline-block;width:1.4cqw;height:1.4cqw;border-radius:50%;background:#2E7D32;vertical-align:middle;margin-right:.7cqw"></span>'
         '<b style="color:#2E7D32">정상</b> — 힘줄 팽팽 → <b>브레이크(GTO) 딱 걸림</b> → 안정</div>'
         '<div style="font-weight:300;font-size:2.0cqw;line-height:1.3;color:#33403B">'
         '<span style="display:inline-block;width:1.4cqw;height:1.4cqw;border-radius:50%;background:#A8352A;vertical-align:middle;margin-right:.7cqw"></span>'
         '<b style="color:#A8352A">경련</b> — 짧아져 <b>힘줄 느슨</b> → <b>브레이크 헐거워짐</b> → 작은 자극에 신호가 <b>스스로 커짐(폭주)</b></div>'
         '<div style="font-weight:700;font-size:1.72cqw;line-height:1.28;color:#6B7680;border-top:1.5px solid #E4E9E8;padding-top:1.3cqw">'
         '근방추 = 가속 &nbsp;·&nbsp; GTO(골지건기관) = 브레이크 &nbsp;·&nbsp; 척수 = 되먹임 회로</div>'
         '</div>'),
  'caption':'＊브레이크(GTO)는 <b>힘줄이 팽팽할 때만</b> 걸린다. 짧아져 느슨하면 <b>브레이크가 헐거워지고</b>, 그때 작은 자극에 신호가 <b>스스로 커져 경련</b>(유력 모델). 발끝 당기면 힘줄 팽팽 → 브레이크 다시 걸려 풀림.'},
 ...
 {'t':'split','eyebrow':'치료 · ESWT · 직접근거','tag':('후향적','amber'),'title':'Li 2021 — 충격파를 어떻게 놓았나','foot':'Li 2021 (Biomed Res Int; PMID 34734084)',
  'items':[
 ...
 # ---- Page 7: Otero-Luis 2024 — 경직에서 빌려온 간접근거 (신규) ----
 {'t':'bullets','eyebrow':'치료 · ESWT · 간접근거','tag':('메타분석','amber'),'title':"Otero-Luis 2024 — '경직'에서 빌려온 근거",'foot':'Otero-Luis 2024 (J Clin Med; PMID 38592705)','items':[
   (0,'<b>무엇을 본 연구?</b> 팔다리 <b>경직(spasticity)</b>에 대한 체외충격파 효과를 모은 <b>체계적 문헌고찰+메타분석</b>(여러 RCT 통합).',''),
   (0,"<b>경직이란?</b> 뇌졸중·척수손상 등으로 근육이 늘 <b>뻣뻣하게 굳어</b> 있는 상태. 경련(cramp)과 다르지만 '<b>근육이 과하게 긴장</b>'하는 점이 닮았다.",''),
   (0,'<b>결과:</b> 충격파가 <b>근긴장도(MAS)를 평균 0.40점 낮춤</b>. MAS(Modified Ashworth Scale)=뻣뻣함을 <b>0~4로 매기는 표준 척도</b>, 낮을수록 부드러움.','green'),
   (0,'<b>근거의 힘:</b> 여러 RCT를 합친 메타분석이라 <b>경직에 대해선 근거가 탄탄</b>(경련 직접근거보다 훨씬 강함).',''),
   (-1,'<b>왜 빌려오나:</b> 표적(종아리)도, 목표(근긴장 풀기)도 겹쳐 → 경련에도 통할 것이라 <b>미루어 기대</b>하는 간접근거.','accent'),
 ]},
...
TITLE = "야간 하지경련 · 문헌고찰 발표 · v1.4 (수정본)"
...
htmlc = htmlc.replace(f'<div class="deckttl">{TITLE}</div>',
                      '<div class="deckttl">야간 하지경련 · 문헌고찰 발표 · <b>v1.4 (수정본)</b></div>')
# 페이지3 힉스필드 이미지 임베드
...
out=os.path.join(BASE,"NLC_발표_웹_v1.4.html")
