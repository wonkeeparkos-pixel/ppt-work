...
SERIES = "고령 하지증상 문헌고찰 시리즈 · 2026 · v2.4"
...
NLC = [
 ...
 {'t':'bullets','eyebrow':'임상 포인트','tag':('흔한 동반','ink'),'title':'요추협착 동반 NLC — 근거가 여기 몰려 있다','foot':'Imura 2015; Park 2017 · 협착 시 NLC 유병률 최대 65%','items':[
   ...
   (0,'실제로 <b>LSS는 수술로도 경련이 잘 안 낫는</b> 편 → <b>말초·대증 접근을 함께</b>.',''),
 ]},
...
TITLE = "야간 하지경련 · 문헌고찰 발표 · v2.4 (수정본)"
...
htmlc = htmlc.replace(f'<div class="deckttl">{TITLE}</div>',
                      '<div class="deckttl">야간 하지경련 · 문헌고찰 발표 · <b>v2.4 (수정본)</b></div>')
# 페이지3 힉스필드 이미지 임베드
...
out=os.path.join(BASE,"NLC_발표_웹_v2.4.html")
