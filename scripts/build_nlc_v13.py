...
SERIES = "고령 하지증상 문헌고찰 시리즈 · 2026 · v1.2"
...
NLC = [
 ...
 {'t':'figure','eyebrow':'병태생리','tag':('그림으로',''),'title':'가속과 브레이크 — 왜 짧아진 근육에서 경련이 나나',
  ...
  'svg':('<img src="__PAGE3IMG__" alt="반사 균형과 경련" '
         ...
         '<b style="color:#2E7D32">정상</b> — 근육 정상 길이 → <b>GTO(브레이크) 켜짐</b> → 척수 되먹임 <b>균형</b></div>'
         '<div style="font-weight:300;font-size:2.0cqw;line-height:1.3;color:#33403B">'
         ...
         '<b style="color:#A8352A">경련</b> — 근육 <b>짧아짐</b> → <b>GTO(브레이크) 풀림</b> → 척수 되먹임 <b>자기증폭(폭주)</b></div>'
         ...
         '근방추 = 가속 &nbsp;·&nbsp; GTO = 브레이크 &nbsp;·&nbsp; 척수 = 되먹임 회로</div>'
         '</div>'),
  'caption':'＊<b>장력↓ → 브레이크(GTO) 풀림 → 척수 자기증폭 → 경련</b> (유력 모델·기원 논쟁 중). 스트레칭하면 장력↑로 브레이크 재작동.'},
...
TITLE = "야간 하지경련 · 문헌고찰 발표 · v1.3 (수정본)"
...
htmlc = htmlc.replace(f'<div class="deckttl">{TITLE}</div>',
                      '<div class="deckttl">야간 하지경련 · 문헌고찰 발표 · <b>v1.3 (수정본)</b></div>')
# 페이지3 힉스필드 이미지 임베드
...
out=os.path.join(BASE,"NLC_발표_웹_v1.3.html")
