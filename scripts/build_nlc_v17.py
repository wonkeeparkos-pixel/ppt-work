...
SERIES = "고령 하지증상 문헌고찰 시리즈 · 2026 · v1.7"
...
NLC = [
 ...
 {'t':'bullets','eyebrow':'병태생리','tag':('기전',''),'title':'다리 근육을 움직이는 신경이 과흥분한다','foot':'Miller & Layzer 2005; Minetto 2011·2013','items':[
   ...
   (0,'<b>불씨는 \'말초\'에서 붙는다:</b> 다리 신경을 마취로 차단해도 경련이 생긴다 → 경련의 <b>출발점은 근육 끝(말초 신경)</b>이다(Minetto 2011).',''),
 ...
 {'t':'split','eyebrow':'치료 · 주사기법','tag':('Lv II','green'),'title':'① 국소마취제 유발점 주사','foot':'Kim 2015 (J Am Board Fam Med)',
  ...
  'aside':{'title':'결과 (Kim 2015)','stat':[('10→1','임상 불면 (명·4주)'),('P<0.01','NRS·빈도·ISI 개선'),('n=12','전향·무대조군')]}},
...
TITLE = "야간 하지경련 · 문헌고찰 발표 · v1.7 (수정본)"
...
htmlc = htmlc.replace(f'<div class="deckttl">{TITLE}</div>',
                      '<div class="deckttl">야간 하지경련 · 문헌고찰 발표 · <b>v1.7 (수정본)</b></div>')
# 페이지3 힉스필드 이미지 임베드
...
out=os.path.join(BASE,"NLC_발표_웹_v1.7.html")
