...
SERIES = "고령 하지증상 문헌고찰 시리즈 · 2026 · v2.1"
...
NLC = [
 ...
 {'t':'bullets','eyebrow':'임상 포인트','tag':('흔한 동반','ink'),'title':'요추협착 동반 NLC — 근거가 여기 몰려 있다','foot':'Imura 2015; Park 2017 · 협착 시 NLC 유병률 최대 65%','items':[
   (0,'야간경련 환자에 <b>요추관협착·신경근병증이 매우 흔하다</b> — 협착 동반 시 NLC 유병률 <b>최대 65%</b>.',''),
   ...
   (0,'<b>주의:</b> 척추레벨 차단(신경근차단·경막외)이 <b>경련</b>을 낫게 한다는 <b>직접 근거는 없음</b>. LSS에선 <b>수술조차 경련은 잘 안 낫는다</b> → 원인치료와 별개로 말초·대증 접근 필요.','red'),
 ]},
...
TITLE = "야간 하지경련 · 문헌고찰 발표 · v2.1 (수정본)"
...
htmlc = htmlc.replace(f'<div class="deckttl">{TITLE}</div>',
                      '<div class="deckttl">야간 하지경련 · 문헌고찰 발표 · <b>v2.1 (수정본)</b></div>')
# 페이지3 힉스필드 이미지 임베드
...
out=os.path.join(BASE,"NLC_발표_웹_v2.1.html")
