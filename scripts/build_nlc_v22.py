...
SERIES = "고령 하지증상 문헌고찰 시리즈 · 2026 · v2.2"
...
TITLE = "야간 하지경련 · 문헌고찰 발표 · v2.2 (수정본)"
...
htmlc = htmlc.replace(f'<div class="deckttl">{TITLE}</div>',
                      '<div class="deckttl">야간 하지경련 · 문헌고찰 발표 · <b>v2.2 (수정본)</b></div>')
# 페이지3 힉스필드 이미지 임베드
...
out=os.path.join(BASE,"NLC_발표_웹_v2.2.html")
