...
SERIES = "고령 하지증상 문헌고찰 시리즈 · 2026 · v2.5"
...
NLC = [
 ...
 # ---- 나의 실제 진료 프로토콜 (신규) ----
 {'t':'bullets','eyebrow':'나의 프로토콜 · 실제 적용','tag':('실전 순서','ink'),'title':'실제 진료 순서 — 신경 축을 겨냥한 단계적 접근','foot':'발표자 실제 진료 프로토콜 · 교육용(개별 적용은 임상 판단) · ④⑥ 미검증 단계 포함',
  'items':[
   (0,'<b>① 설명·검사:</b> "<b>신경 문제이거나 혈관(정맥) 문제</b>일 수 있다"고 설명 → 신경 원인 가능성이 높거나 여건이 되면, <b>의료급여·보훈 환자</b>는 상황에 따라 <b>NCV/EMG</b> 시행.',''),
   (0,'<b>② 방향 설정:</b> 신경 문제로 설명했으므로 <b>신경 축(central)</b>을 겨냥해 진행.',''),
   (0,'<b>③ 1차:</b> <b>무료 ESWT</b> + <b>FGA(또는 비복근 압통점) 주사</b> — 경과 보며 유지 결정.','green'),
   (0,'<b>④ 2차:</b> <b>심비골신경 차단(deep peroneal N. block)</b> — 추후 검증 예정.','accent'),
   (0,'<b>⑤ 3차:</b> <b>무릎 레벨 후경골신경 또는 총비골신경</b>에 <b>비마취제 덱사메타손</b> 주사.','accent'),
...
TITLE = "야간 하지경련 · 문헌고찰 발표 · v2.5 (수정본)"
...
htmlc = htmlc.replace(f'<div class="deckttl">{TITLE}</div>',
                      '<div class="deckttl">야간 하지경련 · 문헌고찰 발표 · <b>v2.5 (수정본)</b></div>')
# 페이지3 힉스필드 이미지 임베드
...
out=os.path.join(BASE,"NLC_발표_웹_v2.5.html")
