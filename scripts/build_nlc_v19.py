...
SERIES = "고령 하지증상 문헌고찰 시리즈 · 2026 · v1.9"
...
NLC = [
 ...
 {'t':'table','eyebrow':'가장 먼저','tag':('감별','ink'),'title':'감별이 필요한 것들 — 밤 다리증상','foot':'감별이 치료의 출발점',
  'headers':['감별 질환','핵심 감별점'],'rows':[
   ...
   ['전해질·약물성','저Ca·저Mg · 이뇨제·statin·LABA'],
  ],
  'note':'＊NLC(진성 야간경련) = <b>통증성 근수축·촉지 근경직·족배굴곡 완화·수면 중</b> (원인 감별 ABI·전해질·요추영상 선행).'},
 ...
 {'t':'split','eyebrow':'치료 · 주사기법','tag':('Lv II','green'),'title':'① 국소마취제 유발점 주사','foot':'Kim 2015 (J Am Board Fam Med)',
  ...
  'aside':{'title':'결과 (Kim 2015)','items':[
   (0,'<b>통증(NRS)</b> 유의 감소',''),
   (0,'<b>경련 빈도</b> 유의 감소',''),
   (0,'<b>불면지수(ISI)</b> 유의 개선',''),
   (0,'모두 <b>1·2·4주 P&lt;0.01</b>',''),
   (-1,'임상 불면: <b>10명 → 4주째 1명</b>','green'),
  ]}},
 ...
 # ---- ⑤ FGA 주사 — 개념·근거 (1/2) ----
 {'t':'figure','eyebrow':'치료 · 주사기법 · 탐색적','tag':('Lv V','amber'),'title':'⑤ FGA 주사 — 개념·근거 (1/2)','foot':'Pedret 2020 (Scand J Med Sci Sports); Balius 2018',
  'svg':(SVG_FGA2 +
         '<div style="flex:1;max-width:37cqw;display:flex;flex-direction:column;justify-content:center;gap:1.5cqw;text-align:left">'
         '<div style="font-weight:300;font-size:1.92cqw;line-height:1.32;color:#33403B"><b>FGA</b>(유리 비복근 건막) = 비복근 <b>내측두 근섬유가 끝나는 원위</b>의 자유 건막 = 원위 근-건 이행부(<b>tennis leg</b> 부위).</div>'
         '<div style="font-weight:300;font-size:1.92cqw;line-height:1.32;color:#33403B"><b>왜 표적:</b> <b>GTO·근방추 밀집</b>·힘 전달 집중 → 경련 호발, 건 자극으로 반사 억제.</div>'
         '<div style="font-weight:300;font-size:1.92cqw;line-height:1.32;color:#33403B"><b>간접 근거:</b> 비복근 국소주사(유발점·BTX)의 야간경련 감소 → FGA는 이를 <b>더 정밀화</b>한 표적.</div>'
         '<div style="font-weight:700;font-size:1.78cqw;line-height:1.3;color:#A8352A;border-top:1.5px solid #E4E9E8;padding-top:1.1cqw">직접 근거 없음 — 신규 가설(Lv V). 표준치료 아님.</div>'
         '</div>'),
  'caption':''},
...
TITLE = "야간 하지경련 · 문헌고찰 발표 · v1.9 (수정본)"
...
htmlc = htmlc.replace(f'<div class="deckttl">{TITLE}</div>',
                      '<div class="deckttl">야간 하지경련 · 문헌고찰 발표 · <b>v1.9 (수정본)</b></div>')
# 페이지3 힉스필드 이미지 임베드
...
out=os.path.join(BASE,"NLC_발표_웹_v1.9.html")
