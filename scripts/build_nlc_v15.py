...
SERIES = "고령 하지증상 문헌고찰 시리즈 · 2026 · v1.5"
...
NLC = [
 ...
 {'t':'figure','eyebrow':'병태생리','tag':('그림으로',''),'title':'가속과 브레이크 — 왜 짧아진 근육에서 경련이 나나',
  ...
  'svg':('<img src="__PAGE3IMG__" alt="정상 vs 경련 — 브레이크와 신호" '
         'style="max-height:100%;max-width:90cqw;width:auto;object-fit:contain;align-self:center;border-radius:1.4cqw;border:1.5px solid #E4E9E8"/>'),
  'caption':'＊그림의 "브레이크 꺼짐"은 실제로 완전히 꺼지는 게 아니라 <b>헐거워지는</b> 것 — GTO는 힘줄 <b>장력</b>에 반응해 짧아지면 약해진다. 유력 모델이며 경련의 중추/말초 기원은 논쟁 중.'},
...
TITLE = "야간 하지경련 · 문헌고찰 발표 · v1.5 (수정본)"
...
htmlc = htmlc.replace(f'<div class="deckttl">{TITLE}</div>',
                      '<div class="deckttl">야간 하지경련 · 문헌고찰 발표 · <b>v1.5 (수정본)</b></div>')
# 페이지3 힉스필드 이미지 임베드
...
out=os.path.join(BASE,"NLC_발표_웹_v1.5.html")
