...
LSB = [
 ...
 {'t':'figsplit','eyebrow':'방법','tag':('기법',''),'title':'방법 (Technique)','foot':'약제: 국소마취제 / 신경파괴는 진단차단 양성 시에만 · StatPearls NBK431107 · NBK560514',
  'svg':SAGITTAL_SVG,
  'items':[
   (0,'<b>복와위 · 투시 유도 방척추 접근</b> (CT·초음파 가능)',''),
   (0,'<b>첫 위치: C-arm 환측 30–35° 사위(oblique)</b> — 횡돌기 끝이 척추체 외측연에 겹치게',''),
   (0,'<b>자입점: 그 상에서 표적 바로 위 피부</b>(정중선 ~7 cm) · 빔과 <b>동축(tunnel view)</b>',''),
   (0,"<b>22 G 15 cm</b> → 척추체 외측면 접촉 → 전내측 'walk' → <b>전외측면</b>",''),
   (-1,'조영제 두미측 확산 · 측면상 전방 1/3 · 성공지표 온도 ≥2°C↑','accent'),
  ]},
 # ---------- L2·L3 조감도 (오리지널 도해) ----------
 ...
 {'t':'key','eyebrow':'핵심 메시지 · LSB','headline':'표준은 투시 유도 방척추 접근, 성공은 온도 ≥2°C','msgs':[
   ('방법','L2–L3 방척추 접근 · <b>C-arm 사위 30–35°</b>로 첫 위치 → 동축 진입'),
   ('약제','국소마취제로 진단/치료, 신경파괴는 진단차단 양성 시에만'),
   ('적응증','조기 CRPS·PAD/CLI 안정통·신경병증·다한증 — NLC·정맥류는 아님'),
   ('효과','관류 실측 개선, 허혈통 최대 75%↓, CRPS 통증완화'),
   ('근거','대규모 RCT 부족 — 조기 CRPS·비재건성 CLI에서 유용'),
 ]},
