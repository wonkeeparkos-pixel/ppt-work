...
LSB = [
 ...
 {'t':'table','eyebrow':'질환 · 가장 먼저','tag':('적응증 + 감별','red'),
  ...
  'foot':'순서는 본 강의의 임상 비중 기준(근거 강도 순서가 아니다) · ABI·도플러로 동맥성 여부 감별이 출발점 · StatPearls; 문헌고찰 종합',
  'note':"공통 관문은 하나 — <b>교감신경 매개 통증(SMP)인가.</b> 진단명이 아니라 <b>진단적 차단의 반응</b>으로 정해진다. "
         "아래 옅은 3개는 증상이 비슷해 헷갈리지만 <b>LSB 적응이 아니다</b> — 먼저 걸러낸다.",
  'headers':['순위','질환','핵심 소견 — 감별점','LSB'],
  'hlrows':[0],'dimrows':[5,6,7],
  'rows':[
   ['<b>①</b>','<b>특발성 SMP</b>','선행 질환 없이 <b>작열통·이질통</b> + 좌우 <b>온도·색·발한</b> 차 · 신경 지배영역을 넘어 퍼짐','<b>○</b>'],
   ...
   ['<b>⑤</b>','난치성 하지통<br>(암성·수술후·외상후)','원인 병소는 설명되나 통증이 남음 — <b>SMP 소견이 겹칠 때</b>만','△'],
   ['—','특발성 야간경련 (NLC)','통증성 <b>근수축</b> · 만져지는 근경직 · <b>족배굴곡으로 완화</b>','✕'],
   ['—','RLS (하지불안)','<b>움직임 충동</b> · 움직이면 완화 · 근경직 없음','✕'],
   ['—','정맥부전·정맥류','부종·무거움 · <b>저녁</b> 악화 · 압박·거상으로 완화 (정맥 역류)','✕'],
  ]},
...
LSB.append({'t':'bullets','eyebrow':'확인과 효과','tag':('진단적 차단','red'),
  ...
  'foot':'진단적 차단의 반응이 SMP/SIP를 가르는 기준 · 온도 상승은 차단 성공의 지표이고 통증 감소가 SMP의 근거 · StatPearls NBK431107',
  ...
  'items':[
   ...
   (-1,'위약 반응과 확산에 의한 체성신경 차단이 위양성을 만든다 — 온도·감각 분포를 함께 기록해 해석한다.','accent'),
  ]})
