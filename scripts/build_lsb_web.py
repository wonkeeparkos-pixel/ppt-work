...
LSB = [
 ...
 {'t':'split','eyebrow':'가장 중요','tag':('SMP 감별','red'),
  'title':'교감신경 매개 통증(SMP) — 이 환자를 골라내야 한다',
  'foot':'SMP = sympathetically-maintained pain · 확진은 진단적 차단 · 반응 예측은 교감피부반응(SSR) · Pain Ther 2023',
  'items':[
   (0,'<b>병명이 아니라 기전이다:</b> 같은 당뇨병성 신경병증이라도 <b>SMP가 있는 환자만</b> 반응한다.','red'),
   (0,'<b>통증의 질:</b> <b>타는 듯한 작열통</b> + <b>이질통</b>(스치기만 해도 아픔)·통각과민.',''),
   (0,'<b>자율신경 징후 — 핵심 단서:</b> 좌우 <b>온도차</b> · 색 변화(발적↔창백↔청색) · <b>발한 이상</b> · 부종',''),
   (0,'<b>유발·분포:</b> <b>추위·스트레스</b>에 악화, 신경 지배영역을 <b>넘어</b> 퍼진다.','green'),
  ],
  'aside':{'title':'확인과 효과','dark':True,'items':[
   (0,'<b>확인</b> 진단적 LSB 후 <b>통증 감소</b> = SMP 확진.',''),
   (0,'<b>성공 판정</b> 피부온도 <b>≥2°C↑</b>.',''),
   (0,'<b>효과</b> 양성이면 반복 차단 → <b>신경파괴·RFA</b>.',''),
   (0,'<b>한계</b> 중추 감작 시 효과 감소.','muted'),
  ]}},
 ...
 {'t':'table','eyebrow':'적응증','tag':('적응',''),'title':'적응증 (Indications) — 우리 진료 비중 순','foot':'StatPearls; 문헌고찰 종합 · 순서는 본 강의의 임상 비중 기준',
  'note':"공통 관문은 <b>교감신경 매개 통증(SMP)인가</b> — 병명보다 이것이 반응을 가른다. 특발성 NLC·정맥질환은 적응 아님.",
  'headers':['순위','범주','대표 적응증'],'rows':[
   ['<b>①</b>','<b>신경병증</b>','<b>당뇨병성 말초신경병증/당뇨발</b> · 대상포진후신경통 · 항암제유발(CIPN) · 환상지통·단단통'],
   ['<b>②</b>','<b>하지통</b>','<b>암성 골반·하지통</b> · 수술후/외상후 난치성 만성 하지통 (SMP 요소가 있을 때)'],
   ['<b>③</b>','허혈질환','PAD·중증 하지허혈(CLI) 안정통·비재건성, 버거병, 색전, 동상, 혈관연축'],
   ['<b>④</b>','CRPS','하지 복합부위통증증후군(I/II) — <b>조기(≤12개월) 시행 유리</b>'],
   ['⑤','기타','족부 다한증, 레이노 증후군(하지)·홍색사지통증'],
  ]},
