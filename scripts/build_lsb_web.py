...
LSB = [
 ...
 # ═══════════ 질환 — 어떤 병에 쓰나 (적응증이 먼저) ═══════════
 {'t':'table','eyebrow':'질환 · 가장 먼저','tag':('적응증 + 감별','red'),
  'title':'LSB는 어떤 병에 쓰나 — 그리고 무엇을 걸러내나',
  'foot':'근거 강도: ③ 허혈성 안정통만 위약대조 이중맹검 RCT 양성(83.5% vs 23.5%, Cross &amp; Cotton 1985, PMID 3898891) · '
         '④ CRPS는 시술 빈도 1위이나 Cochrane은 음성(CD004598.pub4, PMID 27467116), 관찰연구는 양성(PMID 31365367) · '
         '② 당뇨병성 신경병증은 RCT 1편이나 위약군 없음(PMID 32915421), AAN·NeuPSIG 지침에 LSB 권고 없음 · '
         '① SMP 우세형은 RCT·SR·지침 근거 없음(개념+증례 수준) · ABI·도플러가 감별의 출발점',
  'note':"공통 관문은 하나 — <b>교감신경 매개 통증(SMP)인가.</b> 진단명이 아니라 <b>진단적 차단의 반응</b>으로 정해진다. "
         "순서는 <b>본 강의의 임상 비중</b>이며 <b>근거 강도 순이 아니다</b>(근거는 ③→④→②→① 로 거의 역순 — 각주). "
         "아래 옅은 행들은 증상이 비슷해 헷갈리지만 <b>LSB 적응이 아니다</b> — 먼저 걸러낸다.",
  'headers':['순위','질환','핵심 소견 — 감별점','LSB'],
  'hlrows':[0],'dimrows':[5,6,7,8],
  'rows':[
   ['<b>①</b>','<b>SMP 우세형</b><br>선행 질환·유발 사건 불명','작열통·이질통 + 좌우 <b>온도·색·발한</b> 차 · 신경 지배영역을 넘어 퍼짐 — <b>소견은 의심 단서일 뿐, 확정은 차단 반응</b>','<b>○</b>'],
   ['<b>②</b>','<b>당뇨병성 신경병증</b>','양측 <b>‘양말’ 분포</b> 저림·화끈거림 · <b>야간 악화</b> · 모노필라멘트·진동감각 저하','<b>○</b> 난치성'],
   ['<b>③</b>','<b>허혈성 안정통</b><br>(PAD·CLI·버거병)','파행 → 야간 안정통 · <b>다리를 내리면 완화</b> · 차고 창백한 발 · <b>ABI 저하</b>','<b>○</b>'],
   ['<b>④</b>','<b>하지 CRPS</b> (I/II)','손상 정도에 비해 <b>과도한</b> 작열통·이질통 · 부종 · 색/온도 좌우차','<b>○</b> 조기 유리'],
   ['<b>⑤</b>','난치성 하지통<br>(암성·수술후·외상후)','원인 병소는 설명되나 통증이 남음 — <b>진단적 차단이 양성일 때</b>만','△'],
   ...
   ['—','본태성 다한증','<b>통증이 없다</b> — 교감신경 적응증이지만 표적은 <b>발한</b>이지 진통이 아니다','별도 축'],
  ]},
 {'t':'bullets','eyebrow':'질환 · 공통 축','tag':('SMP / SIP','red'),
  'title':'교감신경 매개 통증(SMP)과 SIP — 진단명이 아니라 통증의 성분',
  'foot':'Roberts, Pain 1986;24:297-311 (PMID 3515292) · Stanton-Hicks, Pain 1995;63:127-133 (PMID 8577483) · '
         'Gibbs, Clin Exp Pharmacol Physiol 2008;35:717-24 (PMID 18215185) · 확인 방법은 뒤 \'확인과 효과\' 슬라이드',
  'note':"정의는 하나뿐이다 — <b>교감신경 차단으로 사라지는 통증 성분이 SMP</b>. "
         "<b>작열통·이질통도, 색 변화도 정의가 아니라 동반 소견이다.</b>",
  'items':[
   (0,'<b>SMP</b> = 교감신경 매개 통증. 정의 기준은 <b>올바르게 시행된 교감신경 차단에 대한 통증 반응</b>, 이것 하나뿐이다.','red'),
   (0,'<b>SIP</b> = 교감신경 <b>비</b>의존성 통증(sympathetically <b>independent</b> pain) — 차단으로 줄지 않는 나머지 성분.',''),
   (1,'둘은 환자 분류가 아니라 <b>한 환자 안에 공존하는 두 성분</b>이다. 비율은 환자마다 다르고 <b>시간에 따라 변한다</b> — 만성화될수록 SIP로 기운다.',''),
   (0,'<b>정의에 들어가는 것:</b> 차단 반응뿐. <b>들어가지 않는 것:</b> 작열통·이질통·색 변화·좌우 온도차·발한 이상·부종 — 모두 <b>동반 소견</b>이다.','green'),
   (1,'색 변화가 근거가 못 되는 이유: 이환지의 <b>노르아드레날린은 오히려 낮다</b>(Drummond 1991; Harden 1994). 혈관 이상은 교감 출력 <b>감소</b>+α수용체 <b>상향조절</b>이지 과활성이 아니다.',''),
   (1,'작열통·이질통이 근거가 못 되는 이유: <b>같은 증상에서 SMP와 SIP가 갈린다.</b> 정의라면 SIP라는 범주 자체가 성립하지 않는다.',''),
   (0,'<b>축이 다르다</b> — 혈관운동·발한·영양성 징후는 <b>병(CRPS·Budapest)을 진단</b>하고, 차단 반응은 <b>기전(SMP)을 확정</b>한다.','red'),
   (-1,'검증된 임상 예측인자는 아직 없다 — \'징후가 없다\'가 아니라 <b>\'validated된 것이 없다\'</b>가 정확한 표현.','accent'),
  ]},
 {'t':'bullets','eyebrow':'적응증 · 증상 ②','tag':('당뇨병성 신경병증','green'),
  'title':'환자 증상·호소 ②-1 — 당뇨병성 신경병증: 통증의 성질과 분포','foot':'StatPearls NBK442009; 문헌고찰 종합',
  'items':[
 ...
 {'t':'bullets','eyebrow':'적응증 · 증상 ②','tag':('당뇨병성 신경병증','green'),
  'title':'환자 증상·호소 ②-2 — 당뇨병성 신경병증: 자율신경 소견과 진찰','foot':'StatPearls NBK442009; 문헌고찰 종합',
  'note':"자율신경 소견(작열통·이질통·온도·색·발한 이상)은 <b>SMP를 의심하게 하는 단서</b>일 뿐이다. "
         "<b>검증된 예측인자는 없다</b> — 이질통은 음성 예측(van Eijs 2012, PMID 22143169)과 양성 예측(Hartrick 2004, PMID 17173603)으로 문헌이 서로 반대다. 확정은 진단적 차단.",
  'items':[
 ...
 {'t':'bullets','eyebrow':'적응증 · 증상 ③','tag':('허혈 · 동맥성',''),
  'title':'환자 증상·호소 ③ — 허혈성 안정통 (PAD·CLI·버거병)','foot':'StatPearls; 문헌고찰 종합',
 ...
 {'t':'bullets','eyebrow':'적응증 · 증상 ④','tag':('하지 CRPS',''),
  'title':'환자 증상·호소 ④ — 하지 CRPS','foot':'StatPearls; 문헌고찰 종합',
  'items':[
...
LSB.append({'t':'bullets','eyebrow':'확인과 효과','tag':('진단적 차단','red'),
  ...
  'foot':'온도 상승은 차단이 걸렸다는 지표이고, 통증 감소가 SMP의 근거 — 둘은 다른 것을 말한다 · '
         'Price, Clin J Pain 1998;14:216-226 (맹검 위약 비교) · Anesthesiology 2019;131:883 (PMID 31365367, n=318) · '
         'SSR 진폭 &lt;510 µV·이환 &lt;12개월이 독립 예측인자였으나 단일기관 미재현 (Pain Ther 2023, PMC10199976) · StatPearls NBK431107',
  ...
  'items':[
   ...
   (1,'반복 차단으로 효과가 누적되는지 확인 → 지속적이면 <b>신경파괴(무수알코올·phenol)·RFA</b> 고려.',''),
   ...
   (0,'<b>단일 개방형 양성 차단은 진단이 아니라 가설이다.</b> 교감신경절에 국소마취제 vs 생리식염수를 맹검 비교하면 <b>최대 진통 효과는 차이가 없고 지속시간만 다르다</b>(Price, Clin J Pain 1998;14:216-226).','red'),
   (1,'확산에 의한 <b>체성신경 차단</b>도 위양성을 만든다 — 온도와 <b>감각 분포</b>를 함께 기록해 해석한다.',''),
   (-1,'온도 상승 <b>폭</b>이 진통 정도를 예측하지는 않는다(n=318, PMID 31365367). 차단 반응으로 <b>척수자극기 성공을 예측하지 말 것.</b>','accent'),
  ]})
...
_ORDER = ['요추교감신경차단', '전체 흐름',
          # ── 질환: 어떤 병에 쓰나 ──
          'LSB는 어떤 병에 쓰나', '교감신경 매개 통증(SMP)',
          '증상·호소 ②-1', '증상·호소 ②-2', '신경병증은 당뇨병성만이', '밤에 저리고 화끈거리는 다리',
