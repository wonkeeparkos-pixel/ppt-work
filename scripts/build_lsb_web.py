...
LSB = [
 ...
 {'t':'table','eyebrow':'질환 · 가장 먼저','tag':('적응증 + 감별','red'),
  ...
  'foot':'공통 관문은 SMP인가 — 확정은 차단 반응 · 근거는 임상 비중과 역순: ③만 위약대조 RCT 양성(PMID 3898891) · ④ Cochrane 음성(27467116) · ② 위약군 없음(32915421)',
  'headers':['질환 (임상 비중 순)','핵심 소견 — 감별점','LSB'],
  'hlrows':[0],
  'rows':[
   ['<b>① SMP 우세형</b> (원인 불명)','작열통·이질통 + 좌우 <b>온도·색·발한</b> 차 · 지배영역을 넘어 퍼짐','<b>○</b>'],
   ['<b>② 당뇨병성 신경병증</b>','양측 <b>‘양말’ 분포</b> 저림·화끈거림 · <b>야간 악화</b> · 모노필라멘트·진동감각 저하','<b>○</b>'],
   ['<b>③ 허혈성 안정통</b> (PAD·CLI)','파행 → 야간 안정통 · <b>다리를 내리면 완화</b> · 차고 창백한 발 · <b>ABI 저하</b>','<b>○</b>'],
 ...
 {'t':'table','eyebrow':'질환 · 먼저 걸러낸다','tag':('감별 제외','ink'),
  ...
  'note':"이 넷은 <b>밤·하지 증상</b>이라는 겉모습만 겹친다. 기전이 교감신경이 아니므로 <b>차단해도 듣지 않는다.</b>",
 ...
 {'t':'bullets','eyebrow':'질환 · 공통 축','tag':('SMP / SIP','red'),
  'title':'교감신경 매개 통증(SMP)과 SIP — 정의는 차단 반응 하나',
  'foot':'Roberts, Pain 1986 (PMID 3515292) · Stanton-Hicks, Pain 1995 (PMID 8577483) · Gibbs 2008 (PMID 18215185)',
  'note':"정의는 하나뿐이다 — <b>교감신경 차단으로 사라지는 통증 성분이 SMP</b>. "
         "<b>작열통·이질통도, 색 변화도 정의가 아니라 동반 소견이다.</b>",
  'items':[
   (0,'<b>SMP</b> = 교감신경 매개 통증. 정의는 <b>올바른 교감신경 차단에 대한 통증 반응</b> 하나뿐이다.','red'),
   (0,'<b>SIP</b> = 교감신경 <b>비</b>의존성 통증 — 차단으로 줄지 않는 나머지 성분.',''),
   (1,'환자 분류가 아니라 <b>한 환자 안에 공존하는 두 성분</b> — 비율은 <b>시간에 따라 변하고</b> 만성화될수록 SIP로 기운다.',''),
   (0,'<b>정의에 드는 것:</b> 차단 반응뿐. <b>안 드는 것:</b> 작열통·이질통·색 변화·온도차·발한 이상·부종 — 모두 <b>동반 소견</b>.','green'),
  ]},
 # ---------- SMP: 소견이 정의가 될 수 없는 이유 ----------
 {'t':'bullets','eyebrow':'질환 · 공통 축','tag':('흔한 오해','red'),
  'title':'SMP — 소견은 왜 정의가 될 수 없나',
  'foot':'Drummond, Pain 1991 · Harden, Pain 1994 · Roberts, Pain 1986 (PMID 3515292) · '
         'Stanton-Hicks, Pain 1995 (PMID 8577483) · Gibbs, Clin Exp Pharmacol Physiol 2008 (PMID 18215185)',
  'items':[
   (0,'<b>색 변화가 근거가 못 되는 이유:</b> 이환지의 <b>노르아드레날린은 오히려 낮다</b>(Drummond 1991; Harden 1994).',''),
   (1,'혈관 이상은 교감 출력 <b>감소</b> + α수용체 <b>상향조절</b>이지 교감 과활성이 아니다.',''),
   (0,'<b>작열통·이질통이 근거가 못 되는 이유:</b> <b>같은 증상에서 SMP와 SIP가 갈린다.</b>',''),
   (1,'그것이 정의라면 SIP라는 범주 자체가 성립하지 않는다.',''),
 ...
 {'t':'bullets','eyebrow':'적응증 · 증상 ②','tag':('당뇨병성 신경병증','green'),
  ...
  'note':"자율신경 소견은 <b>SMP를 의심하게 하는 단서</b>일 뿐 — <b>검증된 예측인자는 없다.</b> 확정은 진단적 차단.",
  'items':[
   (0,'<b>자율신경 동반(= SMP 단서):</b> 발이 <b>차갑거나 화끈</b> · 좌우 <b>온도·색 차이</b> · 발한 증가/감소 · 피부 건조·부종','green'),
   (0,'<b>진찰:</b> 모노필라멘트·진동감각 저하 · 발목반사 소실 · 발톱 변화',''),
   (0,'<b>당뇨발이면:</b> <b>궤양</b>·관류저하 동반 — 통증뿐 아니라 <b>창상 치유</b>도 기대 효과.','red'),
   (0,'<b>감별:</b> RLS·야간경련·허혈성 안정통과 구분(앞 슬라이드).',''),
...
_DENSE = ['전체 흐름', 'LSB는 어떤 병에 쓰나', '교감신경 매개 통증(SMP)', '개요 · 해부 · 원리',
          ...
          '무엇을 걸러내나', 'SMP — 소견은 왜', '확인의 함정', '확인과 효과']
for _s in LSB:
