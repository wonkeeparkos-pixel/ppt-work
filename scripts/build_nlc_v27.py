...
NLC = [
 ...
 # ---- 원인 분포 (표지 다음, 감별 앞) ----
 {'t':'split','eyebrow':'가장 먼저 · 원인','tag':('원인 분포','ink'),'title':'야간경련, 원인은 어디에 — 신경이냐 혈관이냐','foot':'AAFP 2012(대부분 특발성)·요추협착-NLC 연구·JVIR 2022(정맥총) 종합',
  'items':[
   (0,'대부분 <b>특발성(원인 불명)</b> — 성인 60%·노인 50% 경험, 다수는 원인 미상.',''),
   (0,'이차원인 <b>두 축</b>: <b>신경성</b>(요추협착·신경병증)·<b>정맥성</b>(정맥류·CVI).',''),
   (0,'둘은 노인에서 <b>자주 공존</b> → "둘 중 하나"가 아니라 <b>둘 다 본다</b>.','accent'),
   (-1,'⚠ <b>원인별 % 통계는 없음</b> — 조사 집단 따라 비율이 역전(선택편향). 오른쪽은 분포가 아닌 <b>연관 근거</b>.','red'),
  ],
  'aside':{'title':'이차원인 3갈래 · 연관 근거','items':[
   (0,'<b>특발성:</b> 다수 — 원인 미상'),
   (0,'<b>신경성:</b> 협착 동반 NLC <b>최대 65%</b>'),
   (0,'<b>정맥성:</b> 정맥클리닉 경련환자 <b>92%</b> 정맥이상 · 경화 후 <b>93%↓</b>'),
   (0,'<b>기타:</b> 대사·약물·임신·간경변'),
  ]}},
 ...
 # ---- Page 8: ① 유발점 주사 (상세) ----
 {'t':'split','eyebrow':'치료 · 주사기법','tag':('Lv II','green'),'title':'① 국소마취제 유발점 주사 · Kim 2015 (n=12)','foot':'Kim 2015 (J Am Board Fam Med) · 전향·대조군 없음',
  'items':[
  ...
  'aside':{'title':'결과 (1·2·4주 추적)','items':[
   (0,'<b>통증(NRS) · 경련 빈도 · 불면(ISI)</b>',''),
   (-1,'→ <b>전 시점 유의 감소 (P&lt;0.01)</b>','green'),
   (0,'임상 불면 환자:',''),
   (-1,'<b>10 → 3(2주) → 1(4주)명</b> (P=.012·.001)','green'),
  ]}},
 ...
 # ---- ② 심비골 주사 위치 그림 (신규) ----
 {'t':'bigfig','eyebrow':'치료 · 주사기법 · 위치','tag':('주사 위치',''),'title':'② 심비골신경 차단 — 정확한 주사 위치','foot':'Imura 2015 기법 · 발등 접근 · 신경 말단이 제1 발가락사이에서 갈라짐',
  'svg':'<img src="__DPNIMG__" alt="발등 주사 위치"/>'},
 ...
 # ---- 요추협착 동반 NLC (신규) ----
 {'t':'bullets','eyebrow':'임상 포인트','tag':('흔한 동반','ink'),'title':'요추협착 동반 NLC — 근거가 여기 몰려 있다','foot':'Imura 2015; Park 2017 · 협착 시 NLC 유병률 최대 65%','items':[
   (0,'야간경련 환자에 <b>요추관협착·신경근병증 동반이 흔하다</b> — NLC 유병률 <b>최대 65%</b>.',''),
   (0,'주사 근거의 <b>핵심 두 연구가 사실 다 요추환자</b>다:',''),
   (1,'<b>Imura 2015</b>(심비골신경 차단) = <b>요추수술 후</b>에도 남은 경련 환자',''),
   (1,'<b>Park 2017</b>(비복근 보툴리눔 RCT) = <b>요추관협착증</b> 환자',''),
   (-1,'중추(척추) 문제인데도 <b>발의 말초 차단(Imura)이 들었다</b> → 협착이 있어도 <b>말초 접근이 유효</b>.','accent'),
   (0,'<b>척추레벨 차단</b>(신경근차단·경막외)도 <b>이론적으로 시도해볼 수 있다</b> — 다만 NLC에 <b>직접 근거가 아직 없을 뿐</b>(효과 없음이 밝혀진 게 아니라 <b>연구가 안 된 것</b>).','amber'),
   (0,'실제로 <b>요추협착은 수술로도 경련이 잘 안 낫는</b> 편 → <b>말초·대증 접근을 함께</b>.',''),
 ]},
 ...
 # ---- 나의 실제 진료 프로토콜 1/2 (신규·분리) ----
 {'t':'bullets','eyebrow':'나의 프로토콜 · 실제 적용 (1/2)','tag':('실전 순서','ink'),'title':'실제 진료 순서 — 설명 · 방향 · 1차 처치','foot':'발표자 실제 진료 프로토콜 · 교육용(개별 적용은 임상 판단)',
  'items':[
   (0,'<b>① 설명·검사:</b> "<b>신경 문제이거나 혈관(정맥) 문제</b>일 수 있다"고 설명 → 신경 원인 가능성이 높거나 여건이 되면, <b>의료급여·보훈 환자</b>는 상황에 따라 <b>NCV/EMG</b> 시행.',''),
   (0,'<b>② 방향 설정:</b> 신경 문제로 설명했으므로 <b>요추(lumbar)</b>를 겨냥해 진행.',''),
   (0,'<b>③</b> <b>무료 ESWT</b> + <b>FGA 주사</b>.','green'),
   (0,'<b>④</b> <b>비복근 압통점 주사</b> — 경과 보며 유지 여부 결정.','green'),
  ]},

 # ---- 나의 실제 진료 프로토콜 2/2 (신규·분리) ----
 {'t':'bullets','eyebrow':'나의 프로토콜 · 실제 적용 (2/2)','tag':('실전 순서','ink'),'title':'실제 진료 순서 — 신경 차단 · 경험적 · 약물','foot':'발표자 실제 진료 프로토콜 · 교육용 · ⑤·⑦ 미검증 단계 포함',
  'items':[
   (0,'<b>⑤</b> <b>심비골신경 차단(deep peroneal N. block)</b> — 추후 검증 예정.','accent'),
   (0,'<b>⑥</b> <b>무릎 레벨 후경골신경 또는 총비골신경</b>에 <b>비마취제 덱사메타손</b> 주사.','accent'),
   (0,'<b>⑦ 경험적(Lv V):</b> 중추 요인 고려 <b>경막외 차단(epidural block)</b> — 다 안 들을 때 시도하면 <b>간혹 효과</b>.','amber'),
   (0,'<b>⑧ 약물:</b> 추후 <b>성장 클리닉</b>과 함께 <b>비치 예정</b>.','muted'),
  ]},
...
_dp=_b64.b64encode(open(os.path.join(BASE,"assets/dpn_inject.jpg"),'rb').read()).decode()
htmlc = htmlc.replace("__DPNIMG__","data:image/jpeg;base64,"+_dp)
