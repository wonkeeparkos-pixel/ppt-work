...
REFS = [
 dict(no=1, key="StatPearls_LSB", title="Lumbar Sympathetic Block",
      ...
      points=["표적: 교감신경절 밀도가 가장 높은 L2 하 1/3 ~ L3 상 1/3, 척추체 전외측.",
              "표준 술기: 복와위 + 투시 유도 방척추(paravertebral) 접근. C-arm을 환측으로 30–35° 사위(oblique)시켜 횡돌기 끝이 척추체 외측연에 겹치는 상에서 첫 위치를 잡고, 표적 바로 위 피부(정중선 약 7 cm 외측)를 자입점으로 표시한 뒤 빔과 동축(tunnel view)으로 22 G 15 cm 바늘을 진입.",
