...
SERIES = "고령 하지증상 문헌고찰 시리즈 · 2026 · v1.8"
...
NLC = [
 ...
 {'t':'split','eyebrow':'치료 · 주사기법','tag':('Lv II','green'),'title':'① 국소마취제 유발점 주사','foot':'Kim 2015 (J Am Board Fam Med)',
  'items':[
   ...
   (0,'<b>약제:</b> 0.25% 리도카인 <b>1–2 mL</b> (무에피네프린).',''),
   (0,'<b>바늘·표적:</b> <b>25 G</b>·피부 <b>30°</b> 자입 → taut band 최대 압통점(비복근 내측두).',''),
   (0,'<b>확인·빈도:</b> 연축반응(twitch)·<b>주입 전 흡인</b> · 주 1회 · 초음파 유도.',''),
  ],
  'aside':{'title':'결과 (Kim 2015, n=12)','items':[
   (0,'대상: 야간 종아리경련 <b>12명</b>',''),
   (0,'측정: NRS·경련 빈도·불면(ISI)',''),
   (-1,'→ <b>1·2·4주 모두 유의 개선</b> (P<0.01)','green'),
   (0,'불면: <b>10명 → 4주째 1명</b>',''),
  ]}},
 ...
 {'t':'bullets','eyebrow':'치료 · 주사기법 · 탐색적','tag':('Lv V','amber'),'title':'④ 신경주위 덱사메타손 주사 — 가능성','foot':'기전 기반 유추 · 직접 임상근거 없음 (Level V)',
  'items':[
   ...
   (0,'안전: 초음파로 <b>신경 바깥(perineural)에만</b> — 신경 속(intraneural) 금기. 총비골 차단 시 족하수 주의.','red'),
 ]},

 # ---- (신경 초음파 단면 그림 삭제) ----

 # ---- ⑤ FGA 주사 — 개념·근거 (1/2) ----
 {'t':'split','eyebrow':'치료 · 주사기법 · 탐색적','tag':('Lv V','amber'),'title':'⑤ FGA 주사 — 개념·근거 (1/2)','foot':'Pedret 2020 (Scand J Med Sci Sports); Balius 2018',
  'items':[
 ...
 {'t':'figure','eyebrow':'치료 · 주사기법 · 술기','tag':('초음파 술기',''),'title':'⑤ FGA 주사 — 초음파 술기 (2/2)','foot':'임상 술기 · 김형기(그림)·김우선(영상) 원장 · 실제 초음파 스캔',
...
TITLE = "야간 하지경련 · 문헌고찰 발표 · v1.8 (수정본)"
...
htmlc = htmlc.replace(f'<div class="deckttl">{TITLE}</div>',
                      '<div class="deckttl">야간 하지경련 · 문헌고찰 발표 · <b>v1.8 (수정본)</b></div>')
# 페이지3 힉스필드 이미지 임베드
...
out=os.path.join(BASE,"NLC_발표_웹_v1.8.html")
