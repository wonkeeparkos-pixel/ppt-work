...
figsplit_slide(d, "방법 (Technique)", "방법", "기법", [
    (0,"복와위 · 투시 유도 방척추(paravertebral) 접근 (CT·초음파 가능)",INK,True),
    (0,"첫 위치: C-arm 환측 30–35° 사위(oblique) — 횡돌기 끝이 척추체 외측연에 겹치게",INK,True),
    (0,"자입점: 그 상에서 표적 바로 위 피부(정중선 ~7 cm) · 빔과 동축(tunnel view)",INK,True),
    (0,"22 G 15 cm → 척추체 외측면 접촉 → 전내측 'walk' → 전외측면",INK),
    (-1,"조영제 두미측 확산 · 측면상 전방 1/3 · 성공지표 온도 ≥2°C↑",TEALD,True),
], SAG_IMG, "약제: 국소마취제 / 신경파괴는 진단차단 양성 시에만 · StatPearls NBK431107 · NBK560514")
...
d.key_slide("핵심 메시지 — LSB", "표준은 투시 유도 방척추 접근, 성공은 온도 ≥2°C", [
    ("방법","L2–L3 방척추 접근 · C-arm 사위 30–35°로 첫 위치 → 동축 진입"),
...
# ---------- 신경병증 분류 (당뇨병성 외) ----------
d.table_slide("신경병증은 당뇨병성만이 아니다 — 종류와 LSB 적용", "적응증 · 심화", "신경병증 분류", [
    ("분류","대표 질환","LSB 적용"),
...
], [Inches(2.5),Inches(6.6),Inches(2.75)], "교감신경 매개 통증(SMP) 요소가 클수록 LSB 반응이 좋다",
    size=11.5, row_h=Inches(0.6),
    note="핵심: 병명보다 교감신경 매개 통증(SMP)인가가 관건 — 진단적 차단으로 확인 후 결정.")
...
_NORDER = ['요추교감신경차단 (Lumbar', '전체 흐름', '밤·하지 증상 감별', '개요 · 해부 · 원리',
           ...
           '신경병증은 당뇨병성만이', '밤에 저리고 화끈거리는 다리', '효과 (1)', '효과 (2)',
